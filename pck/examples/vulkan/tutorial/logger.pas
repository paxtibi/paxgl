...
type
  ...
  TStack = specialize TStack<TStackItem>;
  ...
  public
    ...
    procedure Enter(const aClassName, aMethodName: string; const Msg: string = ''); overload;
    procedure Enter(const aClassName, aMethodName: string; const Msg: string; const Args: array of const); overload;
    procedure Leave(const aClassName, aMethodName: string; const Msg: string = ''); overload;
    procedure Leave(const aClassName, aMethodName: string; const Msg: string; const Args: array of const); overload;
  end;
...
procedure TLogger.Enter(const aClassName, aMethodName: string; const Msg: string);
begin
  Enter(aClassName, aMethodName, msg, []);
end;

procedure TLogger.Enter(const aClassName, aMethodName: string; const Msg: string; const Args: array of const);
begin
  FDeepLevel += 1;
  Log(llTrace, ' ENTER ' + aClassName + '.' + aMethodName + ' ' + msg, Args);
end;

procedure TLogger.Leave(const aClassName, aMethodName: string; const Msg: string);
begin
  Leave(aClassName, aMethodName, msg, []);
end;

procedure TLogger.Leave(const aClassName, aMethodName: string; const Msg: string; const Args: array of const);
begin
  Log(llTrace, ' LEAVE ' + aClassName + '.' + aMethodName + ' ' + msg, Args);
  FDeepLevel -= 1;
end;
