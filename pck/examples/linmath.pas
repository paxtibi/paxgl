...
procedure Vec2_Add(out r: TVec2; const a, b: TVec2); inline; begin Vec_Add_Generic(r, a, b, 2); end;
procedure Vec2_Sub(out r: TVec2; const a, b: TVec2); inline; begin Vec_Sub_Generic(r, a, b, 2); end;
procedure Vec2_Scale(out r: TVec2; const v: TVec2; s: Single); inline; begin Vec_Scale_Generic(r, v, s, 2); end;
function Vec2_Mul_Inner(const a, b: TVec2): Single; inline; begin Result := Vec_Mul_Inner_Generic(a, b, 2); end;
function Vec2_Len(const v: TVec2): Single; inline; begin Result := Vec_Len_Generic(v, 2); end;
procedure Vec2_Norm(out r: TVec2; const v: TVec2); inline; begin Vec_Norm_Generic(r, v, 2); end;
procedure Vec2_Min(out r: TVec2; const a, b: TVec2); inline; begin Vec_Min_Generic(r, a, b, 2); end;
procedure Vec2_Max(out r: TVec2; const a, b: TVec2); inline; begin Vec_Max_Generic(r, a, b, 2); end;
procedure Vec2_Dup(out r: TVec2; const src: TVec2); inline; begin Vec_Dup_Generic(r, src, 2); end;

// Vec3
procedure Vec3_Add(out r: TVec3; const a, b: TVec3); inline; begin Vec_Add_Generic(r, a, b, 3); end;
procedure Vec3_Sub(out r: TVec3; const a, b: TVec3); inline; begin Vec_Sub_Generic(r, a, b, 3); end;
procedure Vec3_Scale(out r: TVec3; const v: TVec3; s: Single); inline; begin Vec_Scale_Generic(r, v, s, 3); end;
function Vec3_Mul_Inner(const a, b: TVec3): Single; inline; begin Result := Vec_Mul_Inner_Generic(a, b, 3); end;
function Vec3_Len(const v: TVec3): Single; inline; begin Result := Vec_Len_Generic(v, 3); end;
procedure Vec3_Norm(out r: TVec3; const v: TVec3); inline; begin Vec_Norm_Generic(r, v, 3); end;
procedure Vec3_Min(out r: TVec3; const a, b: TVec3); inline; begin Vec_Min_Generic(r, a, b, 3); end;
procedure Vec3_Max(out r: TVec3; const a, b: TVec3); inline; begin Vec_Max_Generic(r, a, b, 3); end;
procedure Vec3_Dup(out r: TVec3; const src: TVec3); inline; begin Vec_Dup_Generic(r, src, 3); end;
...
// Vec4
procedure Vec4_Add(out r: TVec4; const a, b: TVec4); inline; begin Vec_Add_Generic(r, a, b, 4); end;
procedure Vec4_Sub(out r: TVec4; const a, b: TVec4); inline; begin Vec_Sub_Generic(r, a, b, 4); end;
procedure Vec4_Scale(out r: TVec4; const v: TVec4; s: Single); inline; begin Vec_Scale_Generic(r, v, s, 4); end;
function Vec4_Mul_Inner(const a, b: TVec4): Single; inline; begin Result := Vec_Mul_Inner_Generic(a, b, 4); end;
function Vec4_Len(const v: TVec4): Single; inline; begin Result := Vec_Len_Generic(v, 4); end;
procedure Vec4_Norm(out r: TVec4; const v: TVec4); inline; begin Vec_Norm_Generic(r, v, 4); end;
procedure Vec4_Min(out r: TVec4; const a, b: TVec4); inline; begin Vec_Min_Generic(r, a, b, 4); end;
procedure Vec4_Max(out r: TVec4; const a, b: TVec4); inline; begin Vec_Max_Generic(r, a, b, 4); end;
procedure Vec4_Dup(out r: TVec4; const src: TVec4); inline; begin Vec_Dup_Generic(r, src, 4); end;
...
begin
  ...
  begin
    ...
    mS[0][1] := u[2]; mS[0][2] := -u[1];
    mS[1][0] := -u[2]; mS[1][2] := u[0];
    mS[2][0] := u[1]; mS[2][1] := -u[0];
